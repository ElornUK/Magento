...
use P3\PaymentGateway\Validator\SameSite;

class SwitchSameSite
{
    const CONFIG_PATH = 'payment/P3_PaymentGateway/samesite';
    const CONFIG_AFFECTED_KEYS = 'payment/P3_PaymentGateway/affected_keys';
    /**
     * @var SameSite
     */
    private $validator;
